from flask import Flask #importing flask, creating a new flask application instance
import MySQLdb
...
if  __name__ == '__main__': # checking if the script is run directly
    app.run(host='0.0.0.0', port=5002) # running the application on host IPs on port 5000
